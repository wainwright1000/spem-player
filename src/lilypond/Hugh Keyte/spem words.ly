...
wordsIASoprano = \lyricmode {
  ...
  spem in a -- li -- um 
  nun -- quam ha -- bu -- i, 
  nun -- quam ha -- bu -- i, nun -- quam ha -- bu -- i, ha -- _ bu -- i,
  nun -- quam ha -- bu -- _ i,
  nun -- quam _ ha -- bu -- i,
  nun -- quam
  ha -- bu -- _ i, ha -- bu -- _ i,
...
wordsIBAlto = \lyricmode {
  ...
  % 117
  ad hu -- mi -- li -- ta -- _ _ _ _ tem no -- _ _ stram, 
  no -- stram, no -- stram,
  no -- _ _ stram,
...
wordsIIABaritone = \lyricmode {
  ...
  | et o -- mni -- a, 
  pec -- ca -- ta | ho -- mi -- num, 
  et o -- mni -- _ a pec -- ca -- ta ho -- mi -- num
  in tri -- bu -- la -- ti -- o  -- _ _ _ _ _ _ ne
  ...
  no -- _ stram, no -- _ stram, 
  no -- stram,
  no -- stram.
}

wordsIIABass = \lyricmode {
...
wordsIIBTenor = \lyricmode {
  ...
  % 57
  | et pro -- pi -- ti -- us, pro -- pi -- ti -- _ us e -- | _ _ _ _ ris,
  et pro -- | pi -- ti -- us e -- | _ _ ris, 
  pro -- pi -- ti -- us e -- _ ris,
  e -- _ _ _ ris,

  % 70
  | et o -- mni -- _ a pec -- ca -- ta ho -- mi -- num, 
  pec -- ca -- _ _ ta 
  ho -- mi -- num, pec -- _ ca -- | ta ho -- mi -- num, 
  in | tri -- bu -- la -- ti -- o -- ne
...
wordsIIIBSoprano = \lyricmode {
  ...
  % 78
  | in tri -- bu -- la -- _ ti -- o -- _ _ _ _ ne 
  di -- _ mit -- | _ _ tis,
...
wordsIIIBTenor = \lyricmode {
  % 23
  prae -- | ter in te, | De -- us Is -- ra -- | el, 
  prae -- | ter in te, | De -- us Is -- | ra -- _ _ _ _ | _ el, 
  in | te, _ _ _ _ _ _ _ | De -- us | Is -- ra -- el,
